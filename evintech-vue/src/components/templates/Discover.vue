...
<template>
  <!-- <HighlightGame /> -->
  <Suspense><HighlightEvent /></Suspense>
  <EventProchain />
  <!-- <GamePosts :posts="dummyGameList.slice(0, 10)" :slidePerView="3" /> -->
  <!-- <FreeGames /> -->
  <!-- <GamesWithStatus /> -->
  ...
  <!-- <div class="flex flex-col items-center w-full gap-5 px-5 my-20 md:px-0 lg:flex-row lg:gap-8">
    <a
      href="#"
    ...
    <div class="text-sm ">
      ...
      <a
        href="#"
        class="hidden px-5 py-4 font-normal text-black uppercase bg-white rounded-md lg:inline"
      >Learn More</a>
    </div>
  </div> -->
</template>
