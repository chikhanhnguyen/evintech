import cuisine from "@/assets/images/events/cusine_du_monde.jpeg";
import musique from "@/assets/images/events/music2.jpeg";
import game from "@/assets/images/events/escapegame.jpeg";
...
const gameList: IGame[] = [
  {
    ...
    status: "En cours",
    description:
      "Voici la décription de la cuisine de monde.",
    price: "200.500",
    studio: "EVIN'TECH",
    discount: "-35%",
  ...
  },
  {
    ...
    status: "En cours",
    description:
      "Voici la décription de la musique.",
    price: "200.500",
    studio: "EVIN'TECH",
    discount: "-35%",
    discountPrice: "161.850",
  },
  {
    ...
    status: "En cours",
    description:
      "Voici la décription de l'escape game'.",
    price: "200.500",
    studio: "EVIN'TECH",
    discount: "-35%",
    discountPrice: "161.850",
